   ...
   return (
      <section id="hero">
         <div className="relative h-full overflow-hidden py-5 md:py-14">
            <div className="absolute ml-40 mt-[250px]">
               <motion.span
                  animate={['initial']}
                  whileHover={['hover']}
                  variants={{
                  ...
                  className="absolute -top-32 left-0 right-auto cursor-pointer lg:-top-20"
               >
                  <span className="flex items-center">
                     <span className="mt-3 inline-block whitespace-nowrap rounded-full bg-neutral-800 px-4 py-1.5 text-[12px] font-semibold uppercase leading-5 tracking-wide text-white">
                        💯 No 🧢, straight up open-source
                        <br />
                        no hidden fees, ya dig?
                     </span>
                     <svg
               ...
               <div className="mt-10 grid grid-cols-1 md:mt-20">
                  <div className="flex flex-col items-start gap-6 px-7 pb-8 text-center md:items-center md:px-10">
                     ...
                     <p className="max-w-xl text-balance text-left text-base tracking-tight text-black md:text-center md:text-lg dark:font-medium dark:text-white ">
                        150+ free and open-source UI elements built with
                        {' '}
                        <b>React</b>
                        ,
                        <b>Typescript</b>
