...
export default function SidebarCTA() {
   return (
      <Link
         ...
         target="_blank"
         rel="noreferrer"
         className="bg-primary group my-20 flex w-full flex-col items-center justify-center gap-2 rounded-xl p-4 text-center text-lg font-medium leading-tight text-white"
      >
