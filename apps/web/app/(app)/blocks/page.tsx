...
export default async function BlocksPage() {
   ...
   return (
      <div className="gap-3 md:flex md:flex-row-reverse md:items-start">
         <ThemesSwitcher
            themes={themes}
            className="bg-background/95 supports-[backdrop-filter]:bg-background/60 fixed inset-x-0 bottom-0 z-40 mt-12 flex backdrop-blur lg:sticky lg:bottom-auto lg:top-20"
         />
