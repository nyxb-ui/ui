...
import AnimatedBeamMultipleOutputDemo from '~/registry/special/example/animated-beam-multiple-outputs'
import { BentoCard, BentoGrid } from '~/registry/special/bento-grid'
