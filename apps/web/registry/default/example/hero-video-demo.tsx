...
import HeroVideo, { HeroVideoAction } from '~/registry/default/ui/hero-video'
import { MagicCard, MagicContainer } from '~/registry/default/ui/magic-card'
            ...
            <MagicCard className="min-h-[400px] [mask:linear-gradient(0deg,transparent_40%,#fff_100%)]">
               ...
               >
                  ...
                  <video
                     ...
                     playsInline
                     src="https://cdn.nyxbui.design/globe.mp4"
                  />
               </HeroVideo>
            </MagicCard>
         </MagicContainer>
