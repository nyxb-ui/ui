...
export default function FeatureCard4() {
   ...
   return (
      <div className="relative size-full max-w-lg transform-gpu rounded-lg border bg-white [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] md:max-h-[500px] dark:bg-black dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]">
         ...
         >
            <div className="flex size-full items-center justify-center rounded-t-xl bg-transparent p-10">
               <motion.div className="flex h-[230px] w-full items-center justify-between gap-x-4">
                  <motion.div
                     variants={variant1}
                     className="z-[3] flex h-fit w-full  flex-col items-center justify-between gap-2 rounded-md border border-neutral-400/20 bg-white p-5 px-2.5 transition-all duration-100 ease-linear dark:border-neutral-800 dark:bg-neutral-900"
                  >
