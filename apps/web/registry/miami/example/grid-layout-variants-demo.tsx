         ...
         >
            <div className="flex h-full items-center justify-center">
               <div className="text-center">
                  ...
                  <p className="text-muted-foreground mt-1">Minimal and focused</p>
               </div>
            </div>
         </GridLayout>
         ...
         >
            <div className="flex h-full items-center justify-center">
               <div className="text-center">
                  ...
                  <p className="text-muted-foreground mt-1">Column-focused layout</p>
               </div>
            </div>
         </GridLayout>
         ...
         >
            <div className="flex h-full items-center justify-center">
               <div className="text-center">
                  ...
                  <p className="text-muted-foreground mt-1">Row-based organization</p>
               </div>
            </div>
         </GridLayout>
      </div>
