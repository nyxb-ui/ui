...
description: Using nyxb/ui with Next.js 15 and React 19.
---
...
Follow the instructions in the [installation guide](/docs/installation/next) to install nyxb/ui. No flags are needed.
...
If you have any questions, please [open an issue](https://github.com/nyxb-ui/ui/issues) on GitHub.
