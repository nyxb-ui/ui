...
<Callout className="mt-6">
  Note: The `nyxbui.json` file is optional and **only required if you're
...
You can see the JSON Schema for `nyxbui.json` [here](https://nyxbui.design/schema.json).

```json title="nyxbui.json"
{
  "$schema": "https://nyxbui.json/schema.json"
}
```
