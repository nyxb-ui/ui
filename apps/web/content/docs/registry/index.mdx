...
<Callout>
  **Note:** This feature is currently experimental. Help us improve it by
  ...
  out to us](https://github.com/nyxb-ui/ui/discussions).
</Callout>

You can use the `nyxb` CLI to run your own component registry. Running your own registry allows you to distribute your custom components, hooks, pages, and other files to any React project.
...
Registry items are automatically compatible with the `nyxb` CLI and `Open in v0`.
...
If you'd like to see an example of a registry, we have a [template project](https://github.com/nyxb-ui/registry-template) for you to use as a starting point.
